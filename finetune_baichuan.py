...
if __name__ == "__main__":
    ...
    module_name_list = [
        'model.layers.6.input_layernorm', 'model.layers.6.self_attn.W_pack', 'model.layers.6.self_attn.o_proj', 'model.layers.6.post_attention_layernorm', 'model.layers.6.mlp.gate_proj', 'model.layers.6.mlp.down_proj', 'model.layers.6.mlp.up_proj',
        'model.layers.7.input_layernorm', 'model.layers.7.self_attn.W_pack', 'model.layers.7.self_attn.o_proj', 'model.layers.7.post_attention_layernorm', 'model.layers.7.mlp.gate_proj', 'model.layers.7.mlp.down_proj', 'model.layers.7.mlp.up_proj',
        'model.layers.29.input_layernorm', 'model.layers.29.self_attn.W_pack', 'model.layers.29.self_attn.o_proj', 'model.layers.29.post_attention_layernorm', 'model.layers.29.mlp.gate_proj', 'model.layers.29.mlp.down_proj', 'model.layers.29.mlp.up_proj',
        'model.layers.30.input_layernorm', 'model.layers.30.self_attn.W_pack', 'model.layers.30.self_attn.o_proj', 'model.layers.30.post_attention_layernorm', 'model.layers.30.mlp.gate_proj', 'model.layers.30.mlp.down_proj', 'model.layers.30.mlp.up_proj',
    ]
    # 冻结指定结构之外的其他参数
